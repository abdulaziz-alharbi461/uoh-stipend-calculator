      ...
      <main className="container mx-auto flex-1 px-4 py-8">
        <div className="mx-auto max-w-xl space-y-6">
          ...
          {result && <StipendResult result={result} />}
             ...
             <footer className="mt-12 w-full border-t border-gray-200 pb-8 text-center text-xs text-gray-500">
  <div className="max-w-2xl mx-auto pt-8 px-4">
    <p className="mb-1 font-sans">
      هذا الموقع مشروع شخصي لغرض تعليمي ولا يتبع لجامعة حائل رسمياً.
    </p>
